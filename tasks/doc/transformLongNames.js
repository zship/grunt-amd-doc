	...
	util.getDescriptions(graph).forEach(function(obj) {
		...
		matches.forEach(function(match) {
			...
			if (typeName.search(rParams) !== -1) {
				...
				var baseType = Types.getType(baseTypeName, 'parameterized type inside ' + obj.longName + ' description') || Types.defaultType(baseTypeName);
				...
				args.forEach(function(arg, i) {
					...
					var argType = Types.getType(arg, 'parameterized type #' + i + ' inside ' + obj.longName + ' description') || Types.defaultType(arg);
